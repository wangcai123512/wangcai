...
namespace FMS.BLL
{
    ...
    public class PaymentDeclareCostSpendingController : UserController
    {
        public PaymentDeclareCostSpendingController()
            : base("Payment_DeclareCostSpending")
        { }
        ...
        /// <returns></returns>
        public string GetPaymentDeclareCostSpendingList(string rows, string page,string state=null,string invtype=null)
        {
            int count = 0;
            ...
            List = new DeclareCostSpendingSvc().GetPaymentDeclareCostSpendingList(C_GUID, int.Parse(page), int.Parse(rows), out count, state, invtype);

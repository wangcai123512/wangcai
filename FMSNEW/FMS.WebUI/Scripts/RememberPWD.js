...
function SetPwdAndChk() {
    ...
    SetLastUser(usr);
    //如果记住密码选项被选中 
    if (document.getElementById('RemberPwdFlag').checked == true) {
        //取密码值 
...
function GetPwdAndChk() {
    ...
    if (pwd != null) {
        document.getElementById('RemberPwdFlag').checked = true;
        document.getElementById('Password').value = pwd;
    }
    else {
        document.getElementById('RemberPwdFlag').checked = false;

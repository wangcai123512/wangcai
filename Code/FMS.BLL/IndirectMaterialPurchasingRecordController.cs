...
namespace FMS.BLL
{
    ...
    public class IndirectMaterialPurchasingRecordController : UserController
    {
        public IndirectMaterialPurchasingRecordController()
            : base("IndirectMaterialPurchasing_Record")
        { }
        ...
        public string UpdIndirectMaterialPurchasingRecord(string id, string rper, decimal amount, string invtype, string remark, string currency, string addstyle, DateTime date, string description, string state)
        {
            bool result = false;

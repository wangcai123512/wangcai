USE [FMS_Develop]
GO
/****** Object:  StoredProcedure [dbo].[SP_GetSupplierOutFlowCashRecordList]    Script Date: 04/11/2017 16:15:18 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	<Description,供应商流出现金,>
-- =============================================
ALTER PROCEDURE [dbo].[SP_GetSupplierOutFlowCashRecordList]

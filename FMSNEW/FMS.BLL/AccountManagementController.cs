...
namespace FMS.BLL
{
    ...
    public class AccountManagementController:UserController
    {
        ...
        public ActionResult Bank(string id)
        {
            ...
            {
                return View(new BankAccountSvc().GetBank(Session["CurrentCompanyGuid"].ToString(), id).FirstOrDefault());
            }
        }
        ...
        public ActionResult BankAccount(string bid,string id)
        {
            ...
            {
                return View(new BankAccountSvc().GetBankAccount(Session["CurrentCompanyGuid"].ToString(), id).FirstOrDefault());
            }
        }
        ...
        public string GetBankAccounts()
        {
            ...
            {
                strJson.AppendFormat(strFmt,bank.BA_GUID,bank.B_GUID,GetJson(bank.BA_GUID));
            }
        ...
        {
            bank.C_GUID = Session["CurrentCompanyGuid"].ToString();
        ...
        {
            bankAccount.C_GUID = Session["CurrentCompanyGuid"].ToString();

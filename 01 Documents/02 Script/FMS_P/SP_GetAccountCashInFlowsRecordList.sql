USE [FMS_Develop]
GO
/****** Object:  StoredProcedure [dbo].[SP_GetAccountCashInFlowsRecordList]    Script Date: 04/11/2017 11:12:54 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	<Description,账号流入现金,>
-- =============================================
ALTER PROCEDURE [dbo].[SP_GetAccountCashInFlowsRecordList]
...
BEGIN
	...
	SET NOCOUNT ON;
	 ...
	 AND(RC.BA_GUID = @BA_GUID OR @BA_GUID IS NULL OR LEN(@BA_GUID) = 0)

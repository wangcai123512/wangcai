...
function UploadedUpdateClick(id) {
    var type = $("#edithaveuploadedModal #type").val();
    if (type == '税费') {
        var row = $('#bTable').bootstrapTable('getRowByUniqueId', id);
    } else {
        var row = $('#aTable').bootstrapTable('getRowByUniqueId', id);
    }
    //名称
...
//收入附件编辑
//编辑附件
function IncomeUploadedUpdateClick(id) {
    var row = $('#aTable').bootstrapTable('getRowByUniqueId', id);
    //名称
    $("#edithaveuploadedModal #TempFileName").val(row.FileName);
...
jQuery(function () {
    ...
    uploader.on('uploadFinished', function (file) {
        alert('上传成功');
        var myModalState = $('#myModal #State').val();
        $('#editunifiednameModal #TempFileNameFirst').val("");
        $('#editunifiednameModal').modal('hide');
        $('#AttachmentImportModal').modal('hide');
    ...
    uploader.on('uploadComplete', function (file) {        
        ...
        $('#thelist').empty();
        //关闭上传合同附件的模态框
        var uploadformid = $('#uploadformid').val();

...
namespace FMS.BLL
{
    ...
    {
        public AccountSummaryController() : base("Account_Summary") { }
        ...
        public string GetAccSum()
        {
            ...
            List<T_BeginningBalance> beginningBalance =
                new ReportSvc().GetAccountSummary(Session["CurrentCompany"].ToString());
        ...
        public string GetAccSumDtl(string accId)
        {
            return new JavaScriptSerializer().Serialize(
                new ReportSvc().GetAccountSummaryDetails(Session["CurrentCompany"].ToString(), accId));
        }
    }
}
